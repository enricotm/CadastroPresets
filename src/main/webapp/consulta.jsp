...
<title>Consultar Preset</title>
</head>
<body>
	<% Attributes attr = new Attributes(); %>
	<div
		class="d-flex flex-column vh-100 vw-100 align-items-center justify-content-center"
		style="background: linear-gradient(to right, #fc8403 0%, #fca903 100%);">
		<p class="fs-1 mb-5" style="color: #fff; font-weight: bold;">Consultar Preset</p>
		<form action="consulta" method="post" style="width: 90%">
		...
		<form action="" method="post" style="width: 90%">
			...
			<div class="row align-items-center justify-content-center mb-5">
				<div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl me-3">
					<div class="row">
						<div class="w-50">
							...
							<select class="form-select col-sm-6 mb-3" id="body" name="body" required disabled>
						...
						<div class="w-50">
							...
							<select class="form-select col-sm-6 mb-3" id="cor" name="cor" required disabled>
								<option selected disabled hidden value="">Escolher</option>
				...
				<div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl me-3">
					...
					<select class="form-select col-sm-6 mb-3" id="roda" name="roda" required disabled>
						<option selected disabled hidden value="">Escolher</option>
						<%
				...
				<div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl me-3">
					...
					<select class="form-select col-sm-6 mb-3" id="boost" name="boost" required disabled>
						<option selected disabled hidden value="">Escolher</option>
						<%
			...
			<div class="row align-items-center justify-content-center mb-4">
				...
				<a role="button" class="btn btn-light me-5" href="alterar.jsp" style="width: 100px; color: #fff; font-weight: bold; background-color: #e303fc">Alterar</a>
			</div>
		</form>
		<%
